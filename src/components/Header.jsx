...
const Header = () => (
 ...
 <div
      ...
      >
        ...
        <img className="img-fluid profile" src=".../public/Netflix-assets/assets/kids_icon.png" alt="kids" />
        <svg
        ...
        <img className="img-fluid profile" src=".../public/Netflix-assets/assets/avatar.png" alt="" />
      </div>
      </Navbar>
 </div>
)
